	...
	<section>
		...
		<div id="main-content" class="main-content">
			...
			<div class="wrapper">
				<div class="row">
					<div class="col-sm-12">
						<form class="form-horizontal adminex-form" method="post" action="../directory/saveEditDir?ac=<%=ac%>">
		                    ...
		                    <div class="form-group">
		                        <label class="col-sm-2 col-sm-2 control-label">行业名称:</label>
		                        <div class="col-sm-6">
		                            <input type="text" name="dir_name" class="form-control" value="${directory.dir_name}"/>
<!-- 		                            <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
		                        	<input id="type" name="type" type="hidden" value="${directory.type}" />
 			                       	<input id="super_dir_id" name="super_dir_id" type="hidden" value="${directory.super_dir_id}" />
 			                       	<input id="dir_id" name="dir_id" type="hidden" value="${directory.dir_id}" />
		                        </div>
		                    </div>
		                    <div class="form-group">
		                        <label class="col-sm-2 col-sm-2 control-label">序号:</label>
		                        <div class="col-sm-6">
		                            <input type="text" name="order_id" class="form-control" value="${directory.order_id}"   title="" placeholder="序号" />
		                        </div>
		                    </div>
		                    <div class="form-group">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-6">
		                           <textarea class="form-control" name="summary" rows="5" cols="120">${directory.summary}</textarea>
		                        </div>
		                    </div>  
	...
	<script>
					$('#doback').click(function(){ 
						    location.href = "<%=basePath %>directory/dirIndex?ac=500002&type=1&super_dir_id=1002";
					 });
		 </script>
</body>
</html>