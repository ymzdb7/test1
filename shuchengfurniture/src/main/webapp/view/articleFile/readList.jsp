...
<body class="sticky-header">
					...
					<div class="col-md-12"> 
						<section class="panel">
						      <div class="panel-body"> 
							    ...
							    <form  action="<%=basePath %>article/readList?ac=<%=ac %>" method="post" name="searchForm" id="searchForm">
    ...
    <script>        
                    function updateOrderSc(id){
                     location.href = "<%=basePath%>article/upadteOrderRead?ac=<%=ac%>&id="+id;  
                    }
					function updateOrderScqx(id){ 
					location.href = "<%=basePath%>article/updateOrderReadqx?ac=<%=ac%>&id="+id;   
                    } 
		 </script>
</body>
</html>