	...
	<section>
		...
		<div id="main-content" class="main-content">
			...
			<div class="wrapper">
				<div class="row">
					<div class="col-sm-12">
						<form class="form-horizontal adminex-form" id="form1" method="post" action="../article/saveSubject?ac=<%=ac%>&article_id=${article_id}">
		                    <div class="form-group">
		                        <label class="col-sm-1  control-label">序号:</label>
		                        <div class="col-sm-4"> 
		                         <input type="text" id="indexNum" name="indexNum"  class="form-control" value="" placeholder="请输入题目序号"/>
		                        ...
		                        <div class="col-sm-6"> 
		                         <label class="checkbox-inline">
		                                <input name="subjectType"  type="radio" value="0" onclick="checkType();" checked="checked" >判断题
		                            </label>
		                            <label class="checkbox-inline">
		                                <input name="subjectType"  type="radio" value="1" onclick="checkType();" >单选题
		                            </label>
		                            <label class="checkbox-inline">
		                                <input name="subjectType"  type="radio" value="2" onclick="checkType();">多选题
		                            </label>
		                        </div> 
		                   </div>
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-9">
		                           <textarea class="form-control" name="subjectContent" rows="5" cols="120"></textarea>
		                        </div>
		                    </div>
		                   ...
		                   <div id="pdAnswer" class="form-group" >
		                        ...
		                        <div class="col-sm-9"> 
		                         <input type="text"  id="answer1"  class="form-control" value="" placeholder=""/>
		                   ...
		                   <div id="xzAnswer" class="form-group" style="display: none;">
		                        <label class="col-sm-1  control-label">答案:</label>
		                        <div class="col-sm-9"> 
		                         <input type="text"  id="answer2"  class="form-control" value="" placeholder=""/>
