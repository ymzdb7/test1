...
<body class="sticky-header">
						      ...
						      <div class="panel-body"> 
							    ...
							    <form  action="<%=basePath%>member/queryIntegrationCountList?ac=<%=ac %>" method="post" name="searchForm" id="searchForm">
							       <div class="form-group"> 
				                        <div class="col-sm-2">
				                             <input type="text" name="spare1" class="form-control tooltips"  value="${member.spare1}" placeholder="请输入行业名" />
				                        </div>
				                        <div class="col-sm-2">
    ...
    <script>        
			 ...
			 function queryForm(){
       		 ...
       		 function expExcel(){
		        location.href='<%=basePath%>/member/expExcelBySchool';
		        $('#searchForm').attr("action","<%=basePath%>/member/expExcelBySchool");
		        $('#searchForm').submit();
		    }
