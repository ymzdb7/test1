	...
	<section>
		...
		<div id="main-content" class="main-content">
			...
			<div class="wrapper">
				<div class="row">
					<div class="col-sm-12">
						<form id="form1" class="form-horizontal adminex-form" method="post" action="<%=basePath%>dict/update?ac=<%=ac%>&searchId=${searchId}">
		                    <div class="form-group">
		                        <label class="col-sm-2 col-sm-2 control-label">ID:</label>
		                        <div class="col-sm-6">
		                            <input type="text"  name="dictId" class="form-control" value="${dict.dictId}"/>
		                            <input type="hidden"  name="id" class="form-control" value="${dict.id}"/>
		                        </div>
		                        <input id="searchName" name="searchName" type="hidden" value="${dictName}" />
...
<!-- 		                            <span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span> -->
		                    ...
		                    <div class="form-group" style="text-align: center;">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    &nbsp;&nbsp;
                                    <button class="btn btn-primary" type="button" onclick="doBack()">返回</button>
                                </div> 
                            </div>
		                </form>
					</div>
	...
	<script> 
			        function doBack(){   
                       $('#form1').attr('action','<%=basePath%>dict/index?ac=<%=ac%>&searchId=${searchId}');
                       $('#form1').submit();
                    } 		
					var zTree; 
					var setting = {
					...
					$(document).ready(function() { 
						...
						$('#addDict').click(function(){ 
						    location.href = "<%=basePath%>dict/add?ac=<%=ac%>";
						});
						$('#dictTree').height(200); 
