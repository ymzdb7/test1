...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) { 
    	...
    	try {
			return AlipaySignature.rsaCheckV1(params,AlipayConfig.ali_public_key, AlipayConfig.input_charset);
...
//		}
//		logger.info("检查notify_id:{}",responseTxt);
//	    String sign = "";
//	    if(params.get("sign") != null) {sign = params.get("sign");}
//	    boolean isSign = getSignVeryfy(params, sign);
//	    logger.info("验证签名:{}",isSign);
    ...
    */
    private static String checkUrl(String urlvalue) {
        ...
        try {
            ...
            urlConnection.setConnectTimeout(BaseConstant.maxTime);  
            urlConnection.setReadTimeout(BaseConstant.maxTime); 
